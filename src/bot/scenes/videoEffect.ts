...
const EFFECT_PROMPTS: Record<string, string> = {
  claymation:
    'The characters move in a stop-motion claymation style, with slightly exaggerated movements and clay-like texture. Camera fixed.',
  ghibli:
    'The characters move in a smooth, Ghibli animation style with gentle movements and expressions. Light breeze effect. Camera fixed.',
  pixar:
    'The characters move in a Pixar-style 3D animation with smooth, expressive movements and bright, colorful appearance. Camera fixed.',
  plushify:
    'The characters move like soft plush toys with slight bouncy movements and fabric-like texture. Camera fixed.',
  ghiblify:
    'The characters move in a hand-drawn anime style with fluid movements and emotional expressions. Gentle ambient lighting. Camera fixed.',
  cartoonify:
    'The characters move in a classic cartoon style with exaggerated, bouncy movements and simplified features. Camera fixed.',
  kiss: 'The characters move slightly and kiss each other with naturalistic movements. Camera fixed.',
  jesus:
    'The character is embraced by a Jesus-like figure with divine light and gentle movements. Camera fixed.',
  hug: 'The characters hug each other with warm, natural movements. Camera fixed.',
  microwave:
    'The character spins around slowly like in a microwave with smooth rotation. Camera fixed.',
  animation:
